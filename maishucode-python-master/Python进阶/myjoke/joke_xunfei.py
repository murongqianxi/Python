...
API_KEY = "773322fdfe9e9eeb4912a7de2103be0f"
...
def getHeader():
    ...
    # ttp=ssml
    param = "{\"aue\":\"" + AUE + \
        "\",\"auf\":\"audio/L16;rate=16000\",\"voice_name\":\"xiaoyan\",\"engine_type\":\"intp65\"}"
...
#  待合成文本内容
r = requests.post(URL, headers=getHeader(), data=getBody("你好"))
