...
def main():
    ...
    bomb_front = pygame.font.Font('font/font.ttf', 48)
    bomb_num = 3
    ...
    while running:
        ...
        if life_mun and not paused:
            ...
            for each in big_enemies:
                if each.active:
                    ...
                    pygame.draw.line(screen, enemy_color,
                                     (each.rect.left, each.rect.top-5),
                                     (each.rect.left+int(each.rect.width * enemy_remain), each.rect.top-5),
                                     2)
            ...
            # 绘制全屏炸弹数量
            bomb_text = bomb_front.render('x %d' % bomb_num, True, WHITE)
        ...
        # 绘制游戏结束画面
            ...
            # 绘制结束画面
            record_score_text = score_front.render("Best: %d" % record_score, True, WHITE)
